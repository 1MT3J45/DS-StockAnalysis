...
def job(frequency, period):
    df = pd.read_csv('sp500-Ticker.csv')
    ...
    for ticker in tickers:
        try:
            ...
            x = np.array(pd.read_csv(
                'https://finance.google.com/finance/getprices?i=' + frequency + '&amp;p=' + period + 'd&amp;f=d,o,h,l,c,v&amp;q=' + ticker,
            ...
            # Create Stock Folder
            ticker_path = os.path.join("C:/Users/Yogita\Desktop/Personal/Python Projects/S&amp;P 500 Intraday Data/",
                                       ticker)
            if not os.path.exists(ticker_path):
                os.makedirs(ticker_path)

            # Store CSV
            storage_path = os.path.join("C:/Users/Yogita/Desktop/Personal/Python Projects/S&amp;P 500 Intraday Data/",
                                        ticker, ticker + ".csv")
            ...
            for ticker in tickers:
                read_path = os.path.join("S&amp;P 500 Intraday Data/",
                                         ticker, ticker + ".csv")
...
# schedule.every().monday.at("17:38").do(job, frequency = '3600', period = '1')
# schedule.every().tuesday.at("17:38").do(job, frequency = '3600', period = '1')
# schedule.every().wednesday.at("17:38").do(job, frequency = '3600', period = '1')
# schedule.every().thursday.at("17:38").do(job, frequency = '3600', period = '1')
schedule.every().friday.at("12:54").do(job, frequency='3600', period='1')
